...
# Create an empty `__init__.py` file in the [models](http://_vscodecontentref_/3) directory:

# ```python
# <vscode_codeblock_uri>file:///c%3A/Users/A.S/Documents/Project%20Assignment/app/models/__init__.py</vscode_codeblock_uri>```

# ### Verify Imports

# Ensure that your import statements in [app.py](http://_vscodecontentref_/4) are correct:

# ```python
# <vscode_codeblock_uri>file:///c%3A/Users/A.S/Documents/Project%20Assignment/app.py</vscode_codeblock_uri>import sys
import sys
import os
